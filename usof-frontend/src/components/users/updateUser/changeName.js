...
import {getOneUser, updateFullName} from "../../../redux/users";
...
const ChangeName = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(updateFullName(fullName, T.user.id, auth.token, history));
    }
    ...
    useEffect(() => {
        if (user.specUser) setFullName(user.specUser.full_name);
    }, [user.specUser]);
